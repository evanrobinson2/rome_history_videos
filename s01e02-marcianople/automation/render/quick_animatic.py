#!/usr/bin/env python3
"""Quick-pass S01E02 slideshow: images + music + documentary captions (ASS)."""
...
def segment_from_shot(shot: dict, out: Path, *, review_watermark: bool) -> None:
...
def main() -> None:
    ...
    parser.add_argument("--name", default="S01E02_quick_pass_v2")
    ...
    for shot in shots:
        ...
        segment_from_shot(shot, seg, review_watermark=args.review_watermark)
        segments.append(seg)
