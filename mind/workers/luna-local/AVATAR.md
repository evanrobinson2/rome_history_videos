...
- **Body (spec):** that rune on an owner-paired ASIC, worn as a **badge**. Open LLM + this harness + Bluetooth + Wi‑Fi. Badge: `badge.png`. Die: `asic.png`. Spec: `WRENCH-NODE.md`. Pair: `PAIR.md`.
- **Role:** plumbing
