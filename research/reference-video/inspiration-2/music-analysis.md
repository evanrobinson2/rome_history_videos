# Music Analysis — "I Want to Want" (Peter's Barque)

Source: Facebook reel `1020829287172490`  
Share URL: https://www.facebook.com/share/v/1BxfSbiuVK/  
Artist: **Peter's Barque** (Justin West)  
Duration: **4:55** (295s)  
Local files: `reel.mp4`, `reel-audio.mp3`, `reel.info.json`

---

## What the user heard (and they're right)

The arrangement is deliberately **minimal**:

| Layer | Role |
| --- | --- |
| **Drums** | Tight drum-machine groove — kick, snare/clap on 2 and 4, steady 8th hi-hats |
| **Bass** | **The harmonic engine** — syncopated electric-bass ostinato (repeating riff), bouncy and melodic |
| **Vocals** | **The melody** — rhythmic spoken word locked to the grid; not sung, not choral |
| **Pads** | Sparse warm chords (Rhodes/synth) low in the mix |

There is no lead guitar, no string section, no choir. The voice *is* the top line.

---

## Style names that fit

No single genre label — closest stack:

1. **Spoken word over beat** (primary)
2. **Lo-fi hip-hop instrumental** (drums + bass bed)
3. **Indie pop groove** (clean, punchy, intimate mix)
4. **Alternative / art-pop narration** (Peter's Barque's usual lane)
...
- Vocals very **dry and upfront** (little reverb)
- Bass and kick **tight and separated**
- Overall: modern indie, in-the-room, not cathedral, not lo-fi muddy

---

## Suno prompt for this backing (no vocals)
...
vocals, no choir, no guitar lead, no strings.
```

For the **vocal layer** on top (separate generation or manual record):

```
Single male voice, rhythmic spoken word not singing, dry upfront delivery,
syncopated to beat, clear consonants, conversational but on-grid, no backing
vocals, no choir, no autotune
```

---

## How this differs from the first reference reel

| | First reel (Peter's Barque) | This track ("I Want to Want") |
| --- | --- | --- |
...
Search **"I Want to Want" Peter's Barque** on Spotify or Apple Music — same artist (Justin West).
